package backend.flixel.vis.dsp;

import backend.flixel.vis._internal.html5.AnalyzerNode;
import backend.flixel.vis.audioclip.frontends.LimeAudioClip;
import backend.util.grig.audio.FFT;
import lime.media.AudioSource;

using backend.util.grig.audio.lime.UInt8ArrayTools;
...
class SpectralAnalyzer
{
	...
	public function new(audioSource:AudioSource, barCount:Int = 48, smoothingTimeConstant:Float = 0.8, peakHold:Int = 30)
	{
