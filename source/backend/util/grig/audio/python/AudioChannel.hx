...
abstract AudioChannel(Ndarray)
{
    ...
    public function new(length:Int) {
        this = backend.util.grig.audio.python.numpy.Numpy.zerosLength(length);
    }
    ...
    //     }
    //     var indices:Ndarray = python.Syntax.code('{0}.arange(0, {1}.shape[0])', backend.util.grig.audio.python.numpy.Numpy, this);
    //     var int = backend.util.grig.audio.python.scipy.Interpolate.interp1d(indices, cast this, 'linear');
