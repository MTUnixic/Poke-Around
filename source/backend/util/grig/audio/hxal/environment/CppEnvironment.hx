package backend.util.grig.audio.hxal.environment;

import backend.util.grig.audio.hxal.HVar;
import haxe.DynamicAccess;
import haxe.macro.Context;
import sys.io.File;

class CppEnvironment implements backend.util.grig.audio.hxal.Environment
{
    #if macro
    ...
    public function buildOutput(descriptor:ClassDescriptor, outPath:String):Void {
        ...
        backend.util.grig.audio.hxal.Macro.info('Outputting to path: ${outPath}', Context.currentPos());
