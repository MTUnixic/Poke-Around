...
typedef AudioInterface = backend.util.grig.audio.js.webaudio.AudioInterface;
#elseif (cpp && !DISABLE_PA_AUDIO_INTERFACE)
typedef AudioInterface = backend.util.grig.audio.cpp.AudioInterface;
#elseif (python && !DISABLE_PYTHON_AUDIO_INTERFACE)
typedef AudioInterface = backend.util.grig.audio.python.AudioInterface;
#else
