package backend.util.grig.audio.cpp; #if cpp

import backend.util.grig.audio.AudioBuffer;
import backend.util.grig.audio.InterleavedAudioBuffer;
...
@:build(backend.util.grig.audio.cpp.Build.xml())
...
class AudioInterface
{
    ...
    private var streamInfo = new backend.util.grig.audio.AudioStreamInfo();
    ...
    public function new(api:backend.util.grig.audio.Api = backend.util.grig.audio.Api.Unspecified)
    {
        this.api = api;
    ...
    public static function getApis():Array<backend.util.grig.audio.Api>
    {
        ...
        for (str in PortAudio.getApiStrings()) {
            apis.push(backend.util.grig.audio.PortAudioHelper.apiFromName(str));
        }
        return apis;
    }
